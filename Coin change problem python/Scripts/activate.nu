...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Coding\Github projects\ULPGC-P3-Dynamic-Programming\Coin change problem python'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Coding\Github projects\ULPGC-P3-Dynamic-Programming\Coin change problem python\Scripts\deactivate.nu'
